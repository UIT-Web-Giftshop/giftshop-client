    ...
    <v-flex md8 xs10>
      <v-layout column>
        <v-layout column ma-0 ml-2 mb-2
          ...
          <v-layout row wrap my-4 ml-8 mr-0 justify-space-between align-center>
            <v-flex md3 sm4 xs3>
            ...
            <v-flex md2 xs4 sm3 align-self-center>
              <v-layout justify-space-between align-center max-width="150">
                ...
                <div class="font-weight-bold d-inline" px-4>1</div>
                <v-btn fab small>+</v-btn>
              </v-layout>
            </v-flex>
            ...
            <v-flex md6 xs12 sm12 column>
              ...
              >
              <v-layout my-1 justify-space-between align-center
                ><span>Price</span><span>product.price</span></v-layout
              >
              <v-layout my-1 justify-space-between align-center
        ...
        <v-layout column ma-0 ml-2 my-4
          ><span class="text-h6 text-uppercase">Delivery details</span>
          <v-layout column my-4 ml-8 mr-0>
            <v-layout my-1 justify-space-between align-center>
              <v-text-field label="Name" :rules="rules" hint="Minh Thắng">
              </v-text-field>
            </v-layout>
            <v-layout wrap my-1 justify-space-between align-center>
              ...
              <v-flex md5 sm5 xs5>
                <v-text-field label="Street" :rules="rules" hint="Minh Thắng">
                </v-text-field>
              </v-flex>
            </v-layout>
            <v-layout my-1 justify-space-between align-center>
        ...
        <v-layout mt-4 ml-2>
          <v-row no-gutters wrap align="center" justify="space-between">
            ...
            >
            <v-col md="2" sm="5"
              ><v-btn width="100%" class="warning">Keep</v-btn></v-col
            >
            <v-col md="2" sm="5"
              ><v-btn width="100%" class="error">Cancel</v-btn></v-col
            ></v-row
          >
        </v-layout>
      </v-layout>
